...
void testMpcController(acados_mpc::MPC& mpc,
  ...
  while (t < total_time + 1e-9) {
    ...
    setProgressiveReferences(mpc_data, current_position, desired_position, desired_orientation,
...
int main(int argc, char** argv) {
  ...
  mpc_acados_position_examples::testMpcController(mpc, simulator, sim_config, logger);
  return 0;
}
